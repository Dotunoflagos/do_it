...
-- HBNB_MYSQL_USER=doit_dev HBNB_MYSQL_PWD='Doit1_dev2_p!wd' HBNB_MYSQL_HOST=localhost HBNB_MYSQL_DB=doit_dev_db HBNB_TYPE_STORAGE=db HBNB_API_HOST=0.0.0.0 HBNB_API_PORT=5000 HBNB_LINK=dev python3 -m api.v1.app
